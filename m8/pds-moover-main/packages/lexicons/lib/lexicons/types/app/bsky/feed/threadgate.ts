...
const _followerRuleSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.threadgate#followerRule"),
  ),
});
const _followingRuleSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.threadgate#followingRule"),
  ),
});
const _listRuleSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.threadgate#listRule"),
  ),
...
const _mentionRuleSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("app.bsky.feed.threadgate#mentionRule"),
  ),
});
...
export interface FollowingRule
  extends v.InferInput<typeof followingRuleSchema> {}
