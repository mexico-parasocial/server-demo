  ...
  return [
    {
      ...
      summary:
        'Orbit stays simple for mainstream onboarding while routing sensitive claims through proof-only grants instead of full profile disclosure.',
      surfaceStates: { public: 'Live', civic: 'Limited', dating: 'Muted' },
      signals: [
        {
          label: 'Display identity',
          value: 'Name, avatar, and handle only',
          visibility: 'Public',
          action: 'Preview',
        },
        {
          label: 'Political affiliation',
          value: 'Proof-only routing',
          visibility: 'Private',
          action: 'Inspect',
        },
        {
          label: 'Backup coverage',
          value: 'Backed by PDS MOOver',
    ...
    },
    {
      ...
      summary:
        'Signal is where PARA-style verification, civic eligibility, and limited affiliation claims can be activated without exposing the source records behind them.',
      surfaceStates: { public: 'Limited', civic: 'Live', dating: 'Limited' },
      signals: [
        {
          label: 'Civic eligibility',
          value: 'Derived from verifier state',
          visibility: 'Trusted only',
          action: 'Preview',
        },
        {
          label: 'Public-figure status',
          value: 'PARA-backed proof',
          visibility: 'Trusted only',
          action: 'Inspect',
        },
        {
          label: 'Source paperwork',
          value: 'Never shared with apps',
          visibility: 'Private',
          action: 'Locked',
        },
      ],
    },
    {
      ...
      summary:
        'Spark shares bounded alignment and eligibility proofs for trust and matching without handing over raw social, civic, or location data.',
      surfaceStates: { public: 'Muted', civic: 'Limited', dating: 'Live' },
      signals: [
        {
          label: 'Compatibility snapshot',
          value: 'Bounded match card',
          visibility: 'Public',
          action: 'Preview',
        },
        {
          label: 'Party alignment',
          value: 'Yes or bounded range only',
          visibility: 'Trusted only',
          action: 'Route',
        },
        {
          label: 'Identity anchors',
          value: 'Exact location hidden',
          visibility: 'Private',
          action: 'Inspect',
        },
      ],
