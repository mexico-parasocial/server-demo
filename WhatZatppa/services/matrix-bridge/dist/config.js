...
export function loadConfig() {
    return {
        pdsFirehoseUrl: env('PDS_FIREHOSE_URL', 'wss://pds.para.social/xrpc/com.atproto.sync.subscribeRepos'),
        ...
        pushGatewayUrl: env('PUSH_GATEWAY_URL', 'http://para-matrix-bridge:3001/_matrix/push/v1/notify'),
