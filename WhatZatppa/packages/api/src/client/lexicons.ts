...
export const schemaDict = {
          ...
          schema: {
            ...
            properties: {
              messages: {
                ...
                items: {
                  type: 'ref',
                  ref: 'lex:com.para.agent.defs#messageView',
                },
  ...
  ComParaAlphaGetRolloutStatus: {
    ...
    defs: {
          ...
          schema: {
            ...
            properties: {
              states: {
                ...
                items: {
                  type: 'ref',
                  ref: 'lex:com.para.alpha.getRolloutStatus#stateStatus',
                },
              },
            },
          },
      ...
      stateStatus: {
        type: 'object',
        required: ['state', 'totalSlots', 'usedSlots', 'isOpen'],
        properties: {
          state: {
            type: 'string',
          },
      ...
      main: {
        ...
        record: {
          ...
          properties: {
            ...
            voteVisibility: {
              type: 'string',
              knownValues: ['public', 'party_only', 'anonymous'],
              description:
    ...
    defs: {
      ...
      cabildeoView: {
        ...
        properties: {
          ...
          geo: {
            type: 'ref',
            ref: 'lex:com.para.civic.defs#geoPoint',
          },
          options: {
            type: 'array',
            items: {
          ...
          partyVoteSummary: {
            ...
            items: {
              type: 'ref',
              ref: 'lex:com.para.civic.defs#partyVoteSummary',
            },
          },
          outcomeSummary: {
            type: 'ref',
  ...
  ComParaCivicGetOpenQuestionThread: {
    lexicon: 1,
    ...
    defs: {
          ...
          schema: {
            ...
            properties: {
              ...
              replies: {
                ...
                items: {
                  type: 'ref',
                  ref: 'lex:com.para.civic.getOpenQuestionThread#replyView',
                },
              },
            },
          },
      ...
      replyView: {
        type: 'object',
        required: ['uri', 'cid', 'author', 'text', 'createdAt', 'voteScore'],
        properties: {
          uri: {
            type: 'string',
            format: 'at-uri',
  ...
  ComParaCollectionCreateCollection: {
    lexicon: 1,
  ...
  ComParaCollectionDeleteCollection: {
    lexicon: 1,
  ...
  ComParaCollectionGetCollection: {
    lexicon: 1,
  ...
  ComParaCollectionListCollections: {
    lexicon: 1,
  ...
  ComParaCollectionUpdateCollection: {
    lexicon: 1,
        ...
        record: {
          ...
          properties: {
            ...
            visibility: {
              ...
              knownValues: ['open', 'closed', 'secret'],
              default: 'open',
            },
            chamberMode: {
              type: 'string',
              description: 'Deliberation structure.',
              knownValues: ['unicameral', 'bicameral'],
              default: 'unicameral',
            },
            governanceMode: {
              type: 'string',
  ...
  ComParaCommunityConstitution: {
    ...
    defs: {
      main: {
        ...
        record: {
          type: 'object',
          required: ['community', 'version', 'rules'],
          properties: {
            community: {
              type: 'string',
              format: 'at-uri',
            ...
            rules: {
              type: 'ref',
              ref: 'lex:com.para.community.constitution#rules',
            },
            createdAt: {
              type: 'string',
              format: 'datetime',
      ...
      rules: {
        ...
        properties: {
          ...
          autoModeration: {
            type: 'ref',
            ref: 'lex:com.para.community.constitution#autoModeration',
          },
          budget: {
            type: 'ref',
            ref: 'lex:com.para.community.constitution#budget',
          },
        },
      },
      autoModeration: {
      ...
      main: {
        ...
        record: {
          ...
          properties: {
            ...
            result: {
              type: 'string',
              enum: ['approved', 'rejected', 'tied', 'quorum_not_met'],
            },
            votesFor: {
              type: 'integer',
            },
    ...
    defs: {
      ...
      sharedContentView: {
        ...
        properties: {
          ...
          visibility: {
            type: 'string',
            knownValues: ['community', 'public', 'stewards'],
          },
          sourceApp: {
            type: 'string',
            maxGraphemes: 128,
          ...
          hydrationState: {
            type: 'string',
            knownValues: ['ready', 'unresolved', 'deleted'],
          },
        },
      },
      sharedContentActionView: {
        ...
        properties: {
          ...
          action: {
            type: 'string',
            knownValues: ['remove', 'restore', 'pin', 'unpin'],
          },
          note: {
            type: 'string',
            maxGraphemes: 300,
  ...
  ComParaCommunityDelegation: {
    ...
    defs: {
      main: {
        ...
        record: {
          type: 'object',
          required: ['delegate', 'delegator', 'scope'],
          properties: {
            delegate: {
              type: 'string',
              format: 'did',
            ...
            scope: {
              type: 'ref',
              ref: 'lex:com.para.community.delegation#delegationScope',
            },
            expiresAt: {
              type: 'string',
              format: 'datetime',
      ...
      delegationScope: {
        ...
        properties: {
          mode: {
            type: 'string',
            enum: ['community', 'topic', 'proposal', 'topicCommunity'],
          },
          community: {
            type: 'string',
            format: 'at-uri',
          ...
          topic: {
            type: 'string',
            enum: ['general', 'budget', 'amendment', 'moderation'],
  ...
  ComParaCommunityEigenstate: {
    ...
    defs: {
        ...
        record: {
          ...
          properties: {
            ...
            eigenvalues: {
              ...
              items: {
                type: 'ref',
                ref: 'lex:com.para.community.eigenstate#eigenvalueEntry',
              },
            },
            correlationMatrix: {
              type: 'array',
              items: {
                type: 'ref',
                ref: 'lex:com.para.community.eigenstate#correlationEntry',
              },
            },
            ttlSeconds: {
              type: 'integer',
      ...
      correlationEntry: {
        type: 'object',
        required: ['didA', 'didB', 'correlation'],
        properties: {
          didA: {
            type: 'string',
            format: 'did',
  ...
  ComParaCommunityGetAuditTrail: {
    ...
    defs: {
          ...
          schema: {
            ...
            properties: {
              ...
              votes: {
                ...
                items: {
                  type: 'ref',
                  ref: 'lex:com.para.community.getAuditTrail#voteEntry',
                },
              },
              intensities: {
                type: 'array',
                items: {
                  type: 'ref',
                  ref: 'lex:com.para.community.getAuditTrail#intensityEntry',
                },
              },
              delegations: {
                type: 'array',
                items: {
                  type: 'ref',
                  ref: 'lex:com.para.community.getAuditTrail#delegationEntry',
                },
              },
              tallies: {
                type: 'ref',
                ref: 'lex:com.para.community.getAuditTrail#tallyBreakdown',
              },
              metrics: {
                type: 'ref',
                ref: 'lex:com.para.community.getAuditTrail#concentrationMetrics',
              },
            },
          },
        },
      ...
      voteEntry: {
        type: 'object',
        required: ['voter', 'signal', 'createdAt'],
        properties: {
          voter: {
            type: 'string',
            format: 'did',
      ...
      intensityEntry: {
        type: 'object',
        required: ['voter', 'signal', 'units', 'creditsSpent', 'createdAt'],
        properties: {
          voter: {
            type: 'string',
            format: 'did',
      ...
      delegationEntry: {
        type: 'object',
        required: ['delegate', 'delegator', 'scopeMode', 'createdAt'],
        properties: {
          delegate: {
            type: 'string',
            format: 'did',
      ...
      tallyBreakdown: {
        type: 'object',
        required: ['flat', 'sqrtN', 'correlation'],
        properties: {
          flat: {
            type: 'ref',
            ref: 'lex:com.para.community.getAuditTrail#tallySteps',
          },
          sqrtN: {
            type: 'ref',
            ref: 'lex:com.para.community.getAuditTrail#tallySteps',
      ...
      tallySteps: {
        ...
        properties: {
          steps: {
            ...
            items: {
              type: 'ref',
              ref: 'lex:com.para.community.getAuditTrail#step',
            },
          },
          result: {
            type: 'ref',
            ref: 'lex:com.para.community.getAuditTrail#tallyResult',
          },
        },
      },
      step: {
      ...
      tallyResult: {
        type: 'object',
        required: ['voteCount', 'signalSum', 'signalAverage', 'quorumMet'],
        properties: {
          voteCount: {
            type: 'integer',
          },
  ...
  ComParaCommunityGetTallySimulation: {
    lexicon: 1,
    ...
    defs: {
      main: {
        ...
        output: {
          ...
          schema: {
            type: 'object',
            required: ['flat', 'sqrtN', 'correlation', 'metrics'],
            properties: {
              flat: {
                type: 'ref',
                ref: 'lex:com.para.community.getTallySimulation#tallyResult',
              },
              sqrtN: {
                type: 'ref',
                ref: 'lex:com.para.community.getTallySimulation#tallyResult',
              ...
              metrics: {
                type: 'ref',
                ref: 'lex:com.para.community.getTallySimulation#concentrationMetrics',
              },
            },
          },
        },
      ...
      tallyResult: {
        ...
        properties: {
          ...
          breakdown: {
            ...
            items: {
              type: 'ref',
              ref: 'lex:com.para.community.getTallySimulation#breakdownBucket',
            },
          },
        },
      },
      ...
      main: {
        ...
        record: {
          ...
          properties: {
            ...
            roleRotationRules: {
              type: 'ref',
              ref: 'lex:com.para.community.governanceConfig#roleRotationRules',
            },
            editHistory: {
              type: 'array',
              items: {
  ...
  ComParaCommunityGovernanceConfig: {
    lexicon: 1,
    ...
    defs: {
      main: {
        ...
        record: {
          type: 'object',
          required: ['community', 'version', 'metaRules'],
          properties: {
            community: {
              type: 'string',
              format: 'at-uri',
            ...
            metaRules: {
              type: 'ref',
              ref: 'lex:com.para.community.governanceConfig#metaRules',
            },
            deliberation: {
              type: 'ref',
              ref: 'lex:com.para.community.governanceConfig#deliberationRules',
            },
            delegation: {
              type: 'ref',
              ref: 'lex:com.para.community.governanceConfig#delegationRules',
            },
            counting: {
              type: 'ref',
              ref: 'lex:com.para.community.governanceConfig#countingRules',
            },
            visibility: {
              type: 'ref',
              ref: 'lex:com.para.community.governanceConfig#visibilityRules',
            },
            createdAt: {
              type: 'string',
              format: 'datetime',
      ...
      metaRules: {
        type: 'object',
        required: ['quorumPct', 'thresholdPct', 'amendmentQuorumPct'],
        properties: {
          quorumPct: {
            type: 'integer',
            minimum: 0,
      ...
      countingRules: {
        ...
        properties: {
          modes: {
            ...
            items: {
              type: 'string',
              enum: ['flat', 'sqrt_n', 'correlation_adjusted'],
            },
            description:
  ...
  ComParaCommunityIntensity: {
    ...
    defs: {
      main: {
        ...
        record: {
          type: 'object',
          required: ['proposal', 'voter', 'signal', 'units'],
          properties: {
            proposal: {
              type: 'string',
              format: 'at-uri',
    ...
    defs: {
      main: {
        ...
        output: {
          ...
          schema: {
            type: 'ref',
            ref: 'lex:com.para.community.listCommunityRelations#output',
          },
        },
      },
    },
      ...
      output: {
        ...
        properties: {
          relations: {
            ...
            items: {
              type: 'ref',
              ref: 'lex:com.para.community.defs#communityRelationView',
            },
          },
          cursor: {
            type: 'string',
  ...
  ComParaCommunityListDelegations: {
    lexicon: 1,
    ...
    defs: {
          ...
          schema: {
            ...
            properties: {
              ...
              delegations: {
                ...
                items: {
                  type: 'ref',
                  ref: 'lex:com.para.community.listDelegations#delegationView',
                },
              },
            },
          },
      ...
      delegationView: {
        type: 'object',
        required: ['uri', 'cid', 'delegate', 'delegator', 'scope', 'createdAt'],
        properties: {
          uri: {
            type: 'string',
            format: 'at-uri',
          ...
          schema: {
            ...
            properties: {
              ...
              intensities: {
                ...
                items: {
                  type: 'ref',
                  ref: 'lex:com.para.community.listIntensities#intensityView',
                },
              },
            },
          },
  ...
  ComParaCommunityListSharedContent: {
    lexicon: 1,
    ...
    defs: {
      main: {
        ...
        output: {
          ...
          schema: {
            type: 'ref',
            ref: 'lex:com.para.community.listSharedContent#output',
          },
        },
      },
      output: {
        ...
        properties: {
          items: {
            ...
            items: {
              type: 'ref',
              ref: 'lex:com.para.community.defs#sharedContentView',
            },
          },
          cursor: {
            type: 'string',
          ...
          schema: {
            ...
            properties: {
              ...
              votes: {
                ...
                items: {
                  type: 'ref',
                  ref: 'lex:com.para.community.listVotes#voteView',
                },
              },
            },
          },
        ...
        record: {
          ...
          properties: {
            ...
            roleAssignments: {
              ...
              items: {
                type: 'ref',
                ref: 'lex:com.para.community.membership#roleAssignment',
              },
            },
            source: {
              type: 'string',
  ...
  ComParaCommunityProposal: {
    ...
    defs: {
      main: {
        ...
        record: {
          type: 'object',
          required: ['community', 'title', 'body', 'author'],
          properties: {
            community: {
              type: 'string',
              format: 'at-uri',
  ...
  ComParaCommunityRemoveSharedContent: {
    lexicon: 1,
    ...
    defs: {
      main: {
        ...
        input: {
          ...
          schema: {
            type: 'ref',
            ref: 'lex:com.para.community.removeSharedContent#input',
          },
        },
        output: {
          encoding: 'application/json',
          schema: {
            type: 'ref',
            ref: 'lex:com.para.community.removeSharedContent#output',
          },
        },
      },
      input: {
    ...
    defs: {
      main: {
        ...
        input: {
          ...
          schema: {
            type: 'ref',
            ref: 'lex:com.para.community.restoreSharedContent#input',
          },
        },
        output: {
          encoding: 'application/json',
          schema: {
            type: 'ref',
            ref: 'lex:com.para.community.restoreSharedContent#output',
          },
        },
      },
      input: {
    ...
    defs: {
      main: {
        ...
        output: {
          ...
          schema: {
            type: 'ref',
            ref: 'lex:com.para.community.shareContent#output',
          },
        },
      },
      output: {
        type: 'object',
        required: ['uri', 'cid', 'sharedContent'],
        properties: {
          uri: {
            type: 'string',
            format: 'at-uri',
  ...
  ComParaCommunitySharedContentAction: {
    lexicon: 1,
    ...
    defs: {
      main: {
        ...
        record: {
          type: 'object',
          required: ['sharedContent', 'communityUri', 'action', 'createdAt'],
          properties: {
            sharedContent: {
              type: 'ref',
              ref: 'lex:com.atproto.repo.strongRef',
  ...
  ComParaCommunityVote: {
    ...
    defs: {
      main: {
        ...
        record: {
          type: 'object',
          required: ['proposal', 'community', 'voter', 'signal'],
          properties: {
            proposal: {
              type: 'string',
              format: 'at-uri',
    ...
    defs: {
      main: {
        ...
        output: {
          ...
          schema: {
            type: 'object',
            required: ['subject', 'aspects', 'computedAt'],
            properties: {
              subject: {
                type: 'string',
                format: 'at-uri',
              ...
              aspects: {
                ...
                items: {
                  type: 'ref',
                  ref: 'lex:com.para.discourse.getAnalysis#aspectAnalysis',
                },
              },
              summary: {
                type: 'string',
      ...
      aspectAnalysis: {
        ...
        properties: {
          ...
          sentiment: {
            type: 'ref',
            ref: 'lex:com.para.discourse.getAnalysis#sentimentDistribution',
          },
          confidence: {
            type: 'integer',
            minimum: 0,
    ...
    defs: {
      main: {
        ...
        output: {
          ...
          schema: {
            type: 'object',
            required: ['subject', 'status', 'keyTakeaways', 'consensusLevel'],
            properties: {
              subject: {
                type: 'string',
                format: 'at-uri',
              ...
              participationMetrics: {
                type: 'ref',
                ref: 'lex:com.para.discourse.getSnapshot#participationMetrics',
              },
              compassDistribution: {
                type: 'array',
                items: {
                  type: 'ref',
                  ref: 'lex:com.para.discourse.getSnapshot#compassPoint',
                },
                description:
  ...
  ComParaDiscourseGetTopics: {
    ...
    defs: {
      ...
      topic: {
        type: 'object',
        required: ['label', 'weight', 'growthRate'],
        properties: {
          label: {
            type: 'string',
          },
    ...
    defs: {
        ...
        output: {
          ...
          schema: {
            ...
            properties: {
              topology: {
                type: 'ref',
                ref: 'lex:com.para.discourse.getTopology#discourseTopology',
              },
            },
          },
        },
      ...
      discourseTopology: {
        ...
        properties: {
          ideologicalCentroid: {
            type: 'ref',
            ref: 'lex:com.para.discourse.getTopology#ideologicalCentroid',
          },
          ideologicalSpread: {
            type: 'integer',
            minimum: 0,
          ...
          positionDensity: {
            type: 'ref',
            ref: 'lex:com.para.discourse.getTopology#positionDensity',
          },
          contestedAxes: {
            type: 'array',
            items: {
              type: 'ref',
              ref: 'lex:com.para.discourse.getTopology#contestedAxis',
            },
            description:
          ...
          argumentBalance: {
            type: 'ref',
            ref: 'lex:com.para.discourse.getTopology#argumentBalance',
          },
          bridgeOpportunities: {
            type: 'array',
            items: {
              type: 'ref',
              ref: 'lex:com.para.discourse.getTopology#bridgeOpportunity',
            },
            description:
          ...
          proposalVelocity: {
            type: 'ref',
            ref: 'lex:com.para.discourse.getTopology#proposalVelocity',
          },
        },
      },
      ideologicalCentroid: {
      ...
      argumentBalance: {
        type: 'object',
        required: ['claims', 'evidence', 'questions', 'rebuttals'],
        properties: {
          claims: {
            type: 'integer',
            minimum: 0,
      ...
      proposalVelocity: {
        type: 'object',
        required: ['proposed', 'deliberating', 'voting', 'resolved'],
        properties: {
          proposed: {
            type: 'integer',
            minimum: 0,
      ...
      bridgeOpportunity: {
        type: 'object',
        required: ['description', 'topicOverlap', 'positionsInvolved'],
        properties: {
          description: {
            type: 'string',
            maxLength: 500,
      ...
      main: {
        ...
        record: {
          ...
          properties: {
            ...
            controllerVisibility: {
              type: 'string',
              knownValues: ['entity_default', 'revealed'],
            },
      ...
      main: {
        ...
        record: {
          ...
          properties: {
            ...
            status: {
              type: 'string',
              knownValues: ['pending', 'active', 'revoked'],
            },
            visibilityDefault: {
              type: 'string',
              knownValues: ['entity_default', 'revealed'],
  ...
  ComParaOfficialEntity: {
    ...
    defs: {
      main: {
        ...
        record: {
          type: 'object',
          required: ['kind', 'status', 'name', 'createdAt'],
          properties: {
            kind: {
              type: 'string',
              knownValues: [
            ...
            status: {
              type: 'string',
              knownValues: ['unclaimed', 'verified', 'retired'],
            },
            name: {
              type: 'string',
              maxLength: 300,
        ...
        record: {
          ...
          properties: {
            answers: {
              ...
              items: {
                type: 'ref',
                ref: 'lex:com.para.raq.assessment#answer',
              },
            },
            results: {
              type: 'array',
  ...
  ComParaRaqDefs: {
    ...
    defs: {
      axisResult: {
        type: 'object',
        required: ['axisId', 'axisTitle', 'score', 'label'],
        properties: {
          axisId: {
            type: 'string',
            maxLength: 64,
      ...
      ideologyMatch: {
        type: 'object',
        required: ['name', 'description', 'matchPercent'],
        properties: {
          name: {
            type: 'string',
            maxLength: 128,
      ...
      partyMatch: {
        type: 'object',
        required: ['partyId', 'partyName', 'matchPercent'],
        properties: {
          partyId: {
            type: 'string',
            maxLength: 64,
      ...
      communityAxisView: {
        type: 'object',
        required: ['id', 'name', 'description', 'votes'],
        properties: {
          id: {
            type: 'string',
            maxLength: 64,
      ...
      proposedQuestionView: {
        type: 'object',
        required: ['id', 'text', 'upvotes', 'downvotes', 'isMainstream'],
        properties: {
          id: {
            type: 'string',
            maxLength: 64,
  ...
  ComParaRaqGetCommunityAlignment: {
    lexicon: 1,
          ...
          schema: {
            ...
            properties: {
              ...
              proposals: {
                ...
                items: {
                  type: 'ref',
                  ref: 'lex:com.para.raq.getProposals#proposalView',
                },
              },
            },
          },
        ...
        output: {
          ...
          schema: {
            ...
            properties: {
              assessment: {
                type: 'ref',
                ref: 'lex:com.para.raq.getUserAlignment#assessmentView',
              },
            },
          },
        },
          ...
          schema: {
            ...
            properties: {
              ...
              reportAction: {
                ...
                description:
                  'Optional report targeting metadata used to update matching report tickets after the moderation event is logged.',
              },
            },
          },
        },
...
export const ids = {
  ...
  ComParaAlphaCreateInvite: 'com.para.alpha.createInvite',
  ...
  ComParaCivicGetOpenQuestionThread: 'com.para.civic.getOpenQuestionThread',
  ...
  ComParaCivicOpenQuestion: 'com.para.civic.openQuestion',
  ComParaCivicOpenQuestionVote: 'com.para.civic.openQuestionVote',
  ...
  ComParaCollectionGetCollection: 'com.para.collection.getCollection',
  ...
  ComParaCommunityGovernanceConfig: 'com.para.community.governanceConfig',
  ...
  ComParaOfficialAction: 'com.para.official.action',
  ComParaOfficialController: 'com.para.official.controller',
  ComParaOfficialEntity: 'com.para.official.entity',
  ComParaPost: 'com.para.post',
  ComParaRaqAssessment: 'com.para.raq.assessment',
  ComParaRaqAxisVote: 'com.para.raq.axisVote',
  ComParaRaqDefs: 'com.para.raq.defs',
  ComParaRaqGetCommunityAlignment: 'com.para.raq.getCommunityAlignment',
  ComParaRaqGetProposals: 'com.para.raq.getProposals',
  ComParaRaqGetUserAlignment: 'com.para.raq.getUserAlignment',
  ComParaRaqProposal: 'com.para.raq.proposal',
  ComParaRaqProposalAnswer: 'com.para.raq.proposalAnswer',
  ComParaRaqProposalVote: 'com.para.raq.proposalVote',
  ComParaSocialGetPostMeta: 'com.para.social.getPostMeta',
  ComParaSocialPostMeta: 'com.para.social.postMeta',
  ComParaSortitionProof: 'com.para.sortition.proof',
