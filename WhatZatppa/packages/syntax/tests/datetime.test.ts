...
const interopValid = readLines(
  `${import.meta.dirname}/interop-files/datetime_syntax_valid.txt`,
)
const interopInvalidSyntax = readLines(
  `${import.meta.dirname}/interop-files/datetime_syntax_invalid.txt`,
)
const interopInvalidParse = readLines(
  `${import.meta.dirname}/interop-files/datetime_parse_invalid.txt`,
)
