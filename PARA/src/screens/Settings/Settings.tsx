      ...
      <Layout.Content>
        <Layout.Center>
          <SettingsList.Container>
            <AgeAssuranceDismissibleNotice
              style={[a.px_lg, a.pt_xs, a.pb_xl]}
            />
            ...
            <SettingsList.LinkItem
              to="/settings/followed-elements"
              label={_(msg`Followed Elements`)}>
            ...
            {IS_NATIVE &&
              findContactsEnabled &&
              !ax.features.enabled(
                ax.features.ImportContactsSettingsDisable,
              ) && (
                <SettingsList.LinkItem
...
function MapSettingsSection() {
  ...
  const providerOptions: Array<{value: MapProvider; label: string}> = [
    {value: 'google', label: 'Google Maps'},
    {value: 'maplibre', label: 'MapLibre (Free)'},
  ]

  return (
    <>
      <View style={[a.px_xl, a.pt_lg, a.pb_xs]}>
      ...
      <View style={[a.px_xl, a.pb_md]}>
        <Text style={[a.text_sm, t.atoms.text, a.mb_xs, a.font_bold]}>
          <Trans>Map provider</Trans>
        </Text>
        {!canChangeProvider && (
          <Text style={[a.text_xs, t.atoms.text_contrast_medium, a.mb_sm]}>
          ...
          {providerOptions.map(opt => (
            <Pressable
              ...
              style={[
                ...
                !canChangeProvider && provider !== opt.value
                  ? {opacity: 0.4}
                  : null,
              ]}>
              <Text
