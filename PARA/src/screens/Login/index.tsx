...
function normalizeLoginServiceUrl(serviceUrl: string) {
  return isLikelyLocalServiceUrl(serviceUrl)
    ? normalizeLocalServiceUrl(serviceUrl)
    : serviceUrl
}
...
export const Login = ({onPressBack}: {onPressBack: () => void}) => {
  ...
  const [serviceUrl, setServiceUrl] = useState(() =>
    normalizeLoginServiceUrl(requestedAccount?.service || DEFAULT_SERVICE),
  )
  ...
  const onSelectAccount = (account?: SessionAccount) => {
    if (account?.service) {
      setServiceUrl(normalizeLoginServiceUrl(account.service))
    }
      ...
      content = (
        <LoginForm
          ...
          setServiceUrl={service =>
            setServiceUrl(normalizeLoginServiceUrl(service))
          }
          onPressBack={() =>
