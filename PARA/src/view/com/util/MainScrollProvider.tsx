...
if (IS_WEB) {
  ...
  window.scroll = function () {
    ...
    return originalScroll.apply(
      this,
      arguments as unknown as Parameters<typeof originalScroll>,
    )
  }
  ...
  window.scrollTo = function () {
    emitter.emit('forced-scroll')
    return originalScrollTo.apply(
      this,
      arguments as unknown as Parameters<typeof originalScrollTo>,
    )
  }
}
