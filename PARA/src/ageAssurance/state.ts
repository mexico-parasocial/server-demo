...
export function useAgeAssuranceState(): AgeAssuranceState {
  ...
  return useMemo(() => {
    /**
     * MVP BYPASS: Age assurance is paused for the MVP release.
     * All users get Full access regardless of region or verification status.
     * This will be re-enabled post-MVP with proper regional compliance.
     */
    return {
