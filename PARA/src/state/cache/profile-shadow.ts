...
import {findAllProfilesInQueryData as findAllProfilesInConvoQueryData} from '#/state/queries/messages/conversation'
...
function* findProfilesInCache(
  ...
  yield* findAllProfilesInConvoQueryData(queryClient, did)
