...
export const gradients = {
  blueLight: {start: '#5A577E', end: colors.blue3}, // buttons
  blue: {start: '#41355B', end: colors.blue3}, // fab
  blueDark: {start: '#30273A', end: colors.blue3}, // avis, banner
}
